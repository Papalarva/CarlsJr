...
class CompaniaWidget extends StatefulWidget {
  const CompaniaWidget({Key? key}) : super(key: key);

  @override
  _CompaniaWidgetState createState() => _CompaniaWidgetState();
}

class _CompaniaWidgetState extends State<CompaniaWidget> {
